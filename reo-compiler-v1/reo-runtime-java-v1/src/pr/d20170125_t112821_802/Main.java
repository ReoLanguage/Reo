...
public class Main {
	...
	public static void main(String[] args) {
		...
		new pr.d20170125_t112821_802.Protocol_d20170125_t112821_985_Chess(
			BlackReturn$1,
			WhiteReturn$1$1,
			WhiteReturn$1$2,
			WhiteReturn$1$3,
		...
		Thread worker0 = new pr.d20170125_t112821_802.Worker_d20170125_t112822_478_Engine(
			WhiteReturn$1$3,
			WhiteCall$1$3
		);

		Thread worker1 = new pr.d20170125_t112821_802.Worker_d20170125_t112822_447_Display(
			BlackMove$1,
			WhiteMove$1
		);

		Thread worker2 = new pr.d20170125_t112821_802.Worker_d20170125_t112822_466_Engine(
			WhiteReturn$1$2,
			WhiteCall$1$2
		);

		Thread worker3 = new pr.d20170125_t112821_802.Worker_d20170125_t112822_492_Engine(
			BlackReturn$1,
			BlackCall$1
		);

		Thread worker4 = new pr.d20170125_t112821_802.Worker_d20170125_t112822_455_Engine(
			WhiteReturn$1$1,
			WhiteCall$1$1
		);
