...
2. Download the reo compiler corresponding to your operating system ( `linux, mac <https://github.com/ReoLanguage/Reo/raw/master/archive/reo-linux_mac.zip>`_, or `windows <https://github.com/ReoLanguage/Reo/raw/master/archive/reo-windows.zip>`_).
