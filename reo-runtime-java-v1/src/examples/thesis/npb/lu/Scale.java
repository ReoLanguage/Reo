...
public class Scale extends LUBase {
	...
	public Scale(Integer id, InputPort initInputPort, InputPort doInputPort,
		...
		ScaleConstructor(init.lu, init.partition2[id - 1][0],
	...
	public void ScaleConstructor(LU lu, int low1, int high1) {
