...
This documentation describes the usage of a Reo compiler, called Lykos, that generates a multithreaded application from single-threaded components and a Reo protocol. 
