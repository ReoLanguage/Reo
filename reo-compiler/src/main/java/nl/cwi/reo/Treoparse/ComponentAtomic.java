 ...
 */
public class ComponentAtomic implements Component {
	 ...
	 */
	public ComponentAtomic(String name, List<String> parameters, List<String> intface, Set<String> inputs, Object atom) {
		this.name = name;
