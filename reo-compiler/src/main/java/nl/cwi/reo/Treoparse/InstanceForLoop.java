 ...
 */
public class InstanceForLoop implements Instance {
	 ...
	 */
	public Set<Instance> components;
	 ...
	 */
	public InstanceForLoop(String parameter, Expression lower, Expression upper, Set<Instance> components) {
	...
	public Program getProgram(Map<String, String> parameters, NodeGenerator generator) throws Exception {
		...
		for (int i = a; i <= b; i++) {
			...
			for (Instance comp : this.components)
