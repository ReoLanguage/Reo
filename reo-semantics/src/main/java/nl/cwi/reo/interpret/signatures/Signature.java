...
/**
 * Result after evaluating a signature expression in a given 
 * set of parameter values and ports.
 */
public final class Signature {
	 ...
	 * @param renaming		interface renaming
	 * @param scope			parameter assignment
	 */
	...
	/**
	 * Gets the interface consisting of a map that assigns a new
	 * port to a subset of existing ports, and hides all other ports
